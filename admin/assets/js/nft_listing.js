...
ClassicEditor
    .create(document.querySelector('#nft_listing_description'))
...
$(document).ready(function() {
    ...
    $("#updateNFTListingForm").validate({
        ...
        messages: {
            nft_listing_title: {
                required: "Please provide a NFT listing title"
            }
        },
        submitHandler: function(form) {
            showLoading();
            var formdata = new FormData(document.getElementById('updateNFTListingForm'));
