...
$(document).ready(function() {
    ...
    $(document).on('click', '.updateNftCategory', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#action').val("Edit");
                $('#nft_category_form_title').html("Update NFT Category");
            }
        })
    });
    $(document).on('click', '.deleteNFTCategory', function(e) {
        ...
        Swal.fire({
            title: 'Are you sure?',
            text: 'You will not be able to recover this nft category!',
            type: "warning",
    ...
    $("#updateNFTCategoryForm").validate({
        ...
        submitHandler: function(form) {
            showLoading();
            var formdata = new FormData(document.getElementById('updateNFTCategoryForm'));
            $.ajax({
