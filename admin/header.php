                    ...
                    <div class="navbar-collapse" id="navbar-mobile">
                        ...
                        <li class="dropdown dropdown-notification nav-item">
                            ...
                            <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                                ...
                                <li class="dropdown-menu-footer">
                                    <a class="dropdown-item p-50 text-primary justify-content-center" href="javascript:void(0)">Read all notifications
                                    </a>
                                </li>
                            </ul>
                        </li>
                        <li class="dropdown dropdown-user nav-item">
                            <a class="dropdown-toggle nav-link dropdown-user-link" href="javascript:void(0);" data-toggle="dropdown">
                                ...
                                <span>
                                    <img class="round" src="<?= ($feadmin['admin_avatar']) ? '../images/'.$feadmin['admin_avatar']:'app-assets/images/portrait/small/avatar-s-11.jpg' ?>" alt="avatar" height="40" width="40">
                                </span>
                            </a>
