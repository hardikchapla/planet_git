                        ...
                        <div class="card">
                            ...
                            <div class="card-body card-dashboard">
                                <div class="table-responsive">
                                    <table id="priceTypeList" class="table zero-configuration">
                                        <thead>
                                            <tr>
                                                <th>No.</th>
                                                <th>Name</th>
...
<!-- END: Content-->
<div class="modal fade text-left" id="updatePriceType" tabindex=" -1" role="dialog" aria-labelledby="myModalLabel33"
    aria-hidden="true">
