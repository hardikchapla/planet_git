                ...
                <nav class="navbar navbar-expand-lg navbar-light px-0">
                    ...
                    <div class="collapse navbar-collapse ss_navbar_menu" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item <?= $active_highVoltageShow ?>"><a class="nav-link" href="high-voltage-show">High Voltage</a></li>
                            <li class="nav-item <?= $active_cinematics ?>"><a class="nav-link" href="cinematics"> Stellar Streams</a></li>
                            <li class="nav-item <?= $active_blog ?>"><a class="nav-link" href="blog">Paraverse</a></li>
                            <li class="nav-item <?= $active_NFTMarketplace ?>"><a class="nav-link" href="nft-marketplace"> The Payload </a></li>
                            <li class="nav-item <?= $active_liveTv ?>"><a class="nav-link" href="liveTV"> PHTV 24/7 </a></li>
                            <li class="nav-item <?= $active_liveChat ?>"><a class="nav-link" href="live-chat">PHTV Live</a></li>
                            <li class="nav-item <?= $active_podcasts ?>"><a class="nav-link" href="podcasts">P.H. One</a></li>
                            <li class="nav-item <?= $active_product ?>"><a class="nav-link" href="product"> Star Outpost </a></li>
                            <li class="nav-item"><a class="nav-link" href="http://www.emotionpicturefactory.com/" target="_blank">eMPF Studios</a></li>
                        </ul>
                    </div>
                </nav>
            </div>
            <div class="ss_mobiles_menuss">
                ...
                <div id="sidebarMenu">
                    <ul class="sidebarMenuInner">
                        ...
                        <li class=""><a class="" href="http://www.emotionpicturefactory.com/" target="_blank">eMPF Studios</a></li>
                    </ul>
                </div>
            </div>
        </div>
